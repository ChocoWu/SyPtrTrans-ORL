...
from ptrtrans.shift_reduce import ShiftReduce
import time
...
class PtrTrans(object):
    ...
    def __call__(self, toks, chars, act_ids, acts, sent_range, pos_list, dep_list, dep_head,
                 sent_len, dss=None, relations=None, neibour_index=None, neibour_type=None):
    ...
    def decode(self, toks, chars, act_ids, acts, sent_range, pos_list, dep_list, dep_head, mtype='dev',
               sent_len=None, dss=None, relations=None, neibour_index=None, neibour_type=None):
        dy.renew_cg()
