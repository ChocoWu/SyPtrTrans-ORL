...
class Trainer(object):
    ...
    def __init__(self, fold_idx):
        ...
        self.trans_model = PtrTrans(self.token_vocab.get_vocab_size(),
                                    self.action_vocab,
                                    self.opi_role_vocab,
                                    self.dep_type_vocab,
                                    self.pos_vocab,
    ...
    def train(self, save_model=True):
        ...
        for epoch in range(joint_config['num_epochs']):
            ...
            # logger.info('holders   P:%.5f, R:%.5f, F:%.5f' % (p_pair_role, r_pair_role, f_pair_role))
